...
const images = [
    'http://oss.shop.eduwork.cn/ad/2020-0820-5f3dfe9530bfd.png',
    'http://oss.shop.eduwork.cn/ad/2020-0820-5f3dfe85ae3fd.png'
];
...
emitter.on('onRefresh', toGetProductList.bind(null, 'reset'));
const search = () => {
    toGetProductList('reset', searchValue.value);
};
const goProductInfo = item => {
    router.push({
        name: 'productInfo',
        query: {
            id: item.id
